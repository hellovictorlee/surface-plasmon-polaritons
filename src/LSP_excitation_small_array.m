...
out=ccc_eparray(eparray,ycen_1,xcen_10,r);   % circle_10
eparray=out;
out=ccc_r_p(r_p,ycen_1,xcen_10,r);
r_p=out;
out=ccc_omega_p(omega_p,ycen_1,xcen_10,r);
omega_p=out;

out=ccc_eparray(eparray,ycen_1,xcen_11,r);   % circle_11
eparray=out;
out=ccc_r_p(r_p,ycen_1,xcen_11,r);
r_p=out;
out=ccc_omega_p(omega_p,ycen_1,xcen_11,r);
omega_p=out;

out=ccc_eparray(eparray,ycen_1,xcen_12,r);   % circle_12
eparray=out;
out=ccc_r_p(r_p,ycen_1,xcen_12,r);
r_p=out;
out=ccc_omega_p(omega_p,ycen_1,xcen_12,r);
omega_p=out;

out=ccc_eparray(eparray,ycen_1,xcen_13,r);   % circle_13
eparray=out;
out=ccc_r_p(r_p,ycen_1,xcen_13,r);
r_p=out;
out=ccc_omega_p(omega_p,ycen_1,xcen_13,r);
omega_p=out;

out=ccc_eparray(eparray,ycen_1,xcen_14,r);   % circle_14
eparray=out;
out=ccc_r_p(r_p,ycen_1,xcen_14,r);
r_p=out;
out=ccc_omega_p(omega_p,ycen_1,xcen_14,r);
omega_p=out;

out=ccc_eparray(eparray,ycen_1,xcen_15,r);   % circle_15
eparray=out;
out=ccc_r_p(r_p,ycen_1,xcen_15,r);
r_p=out;
out=ccc_omega_p(omega_p,ycen_1,xcen_15,r);
omega_p=out;

out=ccc_eparray(eparray,ycen_1,xcen_16,r);   % circle_16
eparray=out;
out=ccc_r_p(r_p,ycen_1,xcen_16,r);
r_p=out;
out=ccc_omega_p(omega_p,ycen_1,xcen_16,r);
omega_p=out;

out=ccc_eparray(eparray,ycen_1,xcen_17,r);   % circle_17
eparray=out;
out=ccc_r_p(r_p,ycen_1,xcen_17,r);
r_p=out;
out=ccc_omega_p(omega_p,ycen_1,xcen_17,r);
omega_p=out;

out=ccc_eparray(eparray,ycen_1,xcen_18,r);   % circle_18
eparray=out;
out=ccc_r_p(r_p,ycen_1,xcen_18,r);
r_p=out;
out=ccc_omega_p(omega_p,ycen_1,xcen_18,r);
omega_p=out;
%-----circle
...
%writegif('Hz_small_circle_array.gif',frame,0.05);
