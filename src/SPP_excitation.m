...
wide_of_needle=5;
r_p(y_position-wide_of_needle:y_position+wide_of_needle,50:nx-i0-1)     = r_p_value;
omega_p(y_position-wide_of_needle:y_position+wide_of_needle,50:nx-i0-1) = omega_p_value;
eparray(y_position-wide_of_needle:y_position+wide_of_needle,50:nx-i0-1) = ep_*ep;
...
writegif('Hz_needle_plane.gif',frame,0.05);
